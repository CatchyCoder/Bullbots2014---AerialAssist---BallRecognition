package bullbots.ballrecognition;
...
public class RecognitionApp extends JFrame {
	...
	private void beginProcessing() {
		...
		while(true) {
			...
			table.putNumber("xdistance", processor.getXDistance());
			table.putBoolean("ballfound", processor.isBallFound());
			table.putNumber("diameter", processor.getDiameter());
		}
	}
}
